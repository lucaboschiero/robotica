...
void motionPlan(Vector6d pos_blocchetto, int classe)
{
  ...
  shifted_final_stand = final_stand + Vector3d(0.02 * (classe), 0, 0);
  q_temp = moveTo(ur5Direct(q_temp), ur5Direct(q_temp) - up_down_di, Vector3d(0., 0.0, 0.0), Vector3d(0., 0.0, 0.0)); // alzo il cubetto
  sleep(1);

  q_temp = moveTo(ur5Direct(q_temp), shifted_final_stand - up_down_di, Vector3d(0., 0.0, 0.0), Vector3d(0., 0.0, 0));

  /*switch (classe)
  {
  case 0:
    q_temp = moveTo(ur5Direct(q_temp), (final_stand + Vector3d(0.1 * (classe), 0, 0)) - up_down_di, Vector3d(0., 0.0, 0.0), Vector3d(0., 0.0, 0));
    break;
  case 1:
    q_temp = moveTo(ur5Direct(q_temp), (final_stand + Vector3d(0.1 * (classe), 0, 0)) - up_down_di, Vector3d(0., 0.0, 0.0), Vector3d(0., 0.0, 0.0)); // muovo da pos_blocchetto a final stand
    break;
  case 2:
    q_temp = moveTo(ur5Direct(q_temp), (final_stand + Vector3d(0.1 * (classe), 0, 0)) - up_down_di, Vector3d(0., 0.0, 0.0), Vector3d(0., 0.0, 0.0));
    break;
  case 3:
    q_temp = moveTo(ur5Direct(q_temp), (final_stand + Vector3d(0.1 * (classe), 0, 0)) - up_down_di, Vector3d(0., 0.0, 0.0), Vector3d(0., 0.0, 0.0));
    break;
  ...
  sleep(2);
  q_temp = moveTo(ur5Direct(q_temp), shifted_final_stand - up_down_di, Vector3d(0., 0.0, 0.0), Vector3d(0., 0.0, 0.0)); // alzo cubetto
}
