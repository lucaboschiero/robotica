...
#define LAPS 5.0
#define TMIN 0.0
#define TMAX 1                     //per invDiffKinematicControlSimComplete
...
typedef Matrix<double,10,3> Matrix30d;
...
Vector6d invDiffKinematiControlComplete(Vector6d q, Vector3d xe, Vector3d xd, Vector3d vd, Vector3d phie, Vector3d phid, Vector3d phiddot, Matrix3d Kp, Matrix3d Kphi);
